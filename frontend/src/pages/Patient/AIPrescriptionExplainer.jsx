...
import { UploadCloud, Pill, AlertTriangle, Info, AlertCircle } from 'lucide-react';
           ...
           <div className="space-y-6">
              ...
              <div className="pro-card p-6">
                 ...
                 <p className="text-sm font-medium text-slate-700 leading-relaxed bg-slate-50 p-4 rounded-xl border border-slate-100">
                    Take 1 tablet after meals, twice a day or as directed by the physician.
                 </p>
              </div>
           </div>
           ...
           <div className="space-y-6">
              ...
              <div className="pro-card p-6">
                 ...
                 <p className="text-sm font-medium text-slate-600 leading-relaxed">
                    Nausea, vomiting, allergic reactions, stomach upset.
                 </p>
              </div>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="pro-card p-8 sm:p-12 mb-8 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 hover:border-blue-400 bg-slate-50/50 hover:bg-blue-50/30 transition-all rounded-3xl min-h-[300px]">
        ...
        <p className="text-sm font-medium text-slate-500">or <button className="text-blue-600 font-bold hover:underline" onClick={handleExplain}>click to upload</button></p>
      </div>
