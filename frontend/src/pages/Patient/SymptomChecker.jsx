          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="  p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-200">
              ...
              <form onSubmit={handleAnalyze} className="space-y-6">
                <div>
                  <textarea
                    className="w-full p-5 bg-gray-50/50 border-2 border-transparent focus:border-teal-100 focus:bg-white rounded-2xl focus:ring-4 focus:ring-teal-500/10 outline-none resize-none transition-all duration-300 text-gray-700 placeholder-gray-400"
                    rows="6"
              ...
              <div className="mt-8 p-5 bg-sky-50/50 border border-sky-100 rounded-2xl flex gap-4 items-start">
                <ShieldAlert className="text-sky-500 shrink-0" />
                <p className="text-xs font-medium text-sky-900/80 leading-relaxed">
              ...
              <div className="  border border-slate-200 rounded-2xl shadow-[0_20px_50px_rgb(0,0,0,0.05)] overflow-hidden animate-[fadeInUp_0.5s_ease-out]">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-teal-100/50 p-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-teal-600 uppercase tracking-wider mt-1">Generated Successfully</p>
                  </div>
                </div>
                ...
                <div className="p-8 sm:p-10 prose prose-blue max-w-none text-gray-700 
                  ...
                  prose-blockquote:border-l-4 prose-blockquote:border-teal-500 prose-blockquote:bg-teal-50 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r-lg prose-blockquote:not-italic
                  ">
